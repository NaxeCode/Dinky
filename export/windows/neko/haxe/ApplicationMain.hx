...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Dinky", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Dinky";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Dinky", null, { width: 640, height: 480 });
